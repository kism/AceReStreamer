...
```text
#EXTM3U
#EXTINF:-1 infohash="1000000000000000000000000000000000000001",IPTV1
acestream://1000000000000000000000000000000000000001
#EXTINF:-1 infohash="1000000000000000000000000000000000000002",IPTV2
acestream://1000000000000000000000000000000000000002
#EXTINF:-1, infohash="1000000000000000000000000000000000000003",IPTV3
acestream://4000000000000000000000000000000000000003
#EXTINF:-1, infohash="1000000000000000000000000000000000000004",IPTV4
...
```json
{
  ...
  "title_filter": {
    ...
    "exclude_words": [],
    "include_words": ["[UK]", "[US]", "[IE]", "[AU]", "[EN]", "[CA]", "[NZ]", "[SG]", "[ZA]"],
...
```json
{
  "type": "html",
  "name": "example-site",
  "url": "https://example.com/acestreams",
  "title_filter": {
    "always_exclude_words": [],
    "always_include_words": [],
    "exclude_words": [],
...
```json
{
  ...
  "url": "https://api.example.com/all_ace_streams",
  "title_filter": {
    "always_exclude_words": [],
    "always_include_words": [],
    "exclude_words": [],
