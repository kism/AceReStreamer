...
def test_add_iptv_source() -> None:
    ...
    new_site = ScrapeSiteIPTV(type="iptv", name="test-iptv", url="http://example.com/playlist.m3u8")
...
def test_add_html_source() -> None:
    ...
    new_site = ScrapeSiteHTML(type="html", name="test-html", url="http://example.com")
...
def test_add_api_source() -> None:
    ...
    new_site = ScrapeSiteAPI(type="api", name="test-api", url="http://example.com/api")
...
def test_add_duplicate_source_fails() -> None:
    ...
    new_site = ScrapeSiteIPTV(type="iptv", name="test-duplicate", url="http://example.com/playlist.m3u8")
...
def test_remove_iptv_source() -> None:
    ...
    new_site = ScrapeSiteIPTV(type="iptv", name="test-remove-iptv", url="http://example.com/playlist.m3u8")
...
def test_remove_html_source() -> None:
    ...
    new_site = ScrapeSiteHTML(type="html", name="test-remove-html", url="http://example.com")
...
def test_remove_api_source() -> None:
    ...
    new_site = ScrapeSiteAPI(type="api", name="test-remove-api", url="http://example.com/api")
