...
import acestreamwebplayer.logger
...
def test_logging_permissions_error(logger, tmp_path, mocker):
    ...
    from acestreamwebplayer.logger import _add_file_handler
...
def test_handler_console_added(logger, app):
    ...
    acestreamwebplayer.logger.setup_logger(**logging_conf)
...
def test_set_log_level(log_level_in: str | int, log_level_expected: int, logger):
    ...
    from acestreamwebplayer.logger import _set_log_level
...
def test_no_loggers_supplied():
    ...
    from acestreamwebplayer.logger import setup_logger
