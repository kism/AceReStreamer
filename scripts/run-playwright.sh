...
# Backend
docker buildx build --quiet --file docker/Dockerfile.backend . -t acerestreamer-backend:latest
docker buildx build --quiet --file docker/Dockerfile.frontend --build-arg VITE_API_URL=${VITE_API_URL} . -t acerestreamer-frontend:latest
