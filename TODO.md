...
With version 1.3.0, i'm scaling down this project to be a simple iptv source for dispatcharr. The following changes will be made:
...
For xc streams the username will be acerestreamer and the password will be set to to a random 20 letter alphanumeric string which will be saved in the config file.
